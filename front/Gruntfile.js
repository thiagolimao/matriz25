      ...
      concat: {
          ...
          vendor: {
            src: [
              ...
              '<%= vendor_src %>/fancyBox/lib/jquery.mousewheel-3.0.6.pack.js', // mousewheel
              '<%= vendor_src %>/fancyBox/source/jquery.fancybox.js', // fancybox
              '<%= vendor_src %>/fancyBox/source/helpers/jquery.fancybox-media.js', // fancybox media
            ],
